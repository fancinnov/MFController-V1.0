...
/* USER CODE BEGIN PV */
MPU6887_Data mpu6887_data;
QMI8658_Data qmi8658_data;
ADIS16470_Data adis16470_data;
QMC5883_Data qmc5883_data;
SPL06_Data spl06_data1,spl06_data2;
PWM_Channel pwm_channel;
uint8_t HeartBeatFlags=0;
uint8_t COMM_0=DEV_COMM, COMM_1=DEV_COMM, COMM_2=DEV_COMM, COMM_3=DEV_COMM, COMM_4=DEV_COMM, COMM_5=DEV_COMM;
/* USER CODE END PV */
